...
**Results**:
- Modified View `search_results.blade.php` to render Bootstrap pagination links (`{{ $movements->links() }}`) and align the row numbers dynamically depending on the current page number.
