...
use App\Imports\DAPlansImport;
use App\Models\DAPlan;
...
class DAPlanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return view('plans.da_plans.search_results', compact('plans'))->render();
        }
        return view('plans.da_plans.index', compact('title', 'section', 'sub_section', 'plans'));
    }
    ...
    public function create()
    {
        ...
        $sub_section = 'Create';
        $section_url = route('plans.da_plans.index');
        return view('plans.da_plans.form', compact('title', 'section', 'sub_section', 'section_url'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('plans.da_plans.index')->with([
    ...
    public function edit($id)
    {
        ...
        return view('plans.da_plans.form', compact('title', 'section', 'sub_section', 'section_url', 'plan'));
    }
