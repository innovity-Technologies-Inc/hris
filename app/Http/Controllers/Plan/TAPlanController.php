...
use App\Imports\Plan\TAPlansImport;
...
class TAPlanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return view('plan.ta_plans.search_results', compact('plans'))->render();
        }
        return view('plan.ta_plans.index', compact('title', 'section', 'sub_section', 'plans'));
    }
    ...
    public function create()
    {
        ...
        $sub_section = 'Create';
        $section_url = route('plan.ta_plans.index');
        return view('plan.ta_plans.form', compact('title', 'section', 'sub_section', 'section_url'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('plan.ta_plans.index')->with([
    ...
    public function edit($id)
    {
        ...
        return view('plan.ta_plans.form', compact('title', 'section', 'sub_section', 'section_url', 'plan'));
    }
