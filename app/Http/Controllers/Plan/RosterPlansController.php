...
use App\Imports\Plan\RosterPlansImport;
...
class RosterPlansController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if ($request->ajax()) {
            return view('plan.roster_plans.search_results', compact('plans'))->render();
        }
        return view('plan.roster_plans.index', compact('title', 'section', 'sub_section', 'plans'));
    }
    public function create(){
        ...
        $sub_section = 'Create';
        $section_url = route('plan.roster_plans.index');
        return view('plan.roster_plans.form', compact('title', 'section', 'sub_section', 'section_url', 'shifts'));
    }
    public function store(Request $request){
        ...
        return redirect()->route('plan.roster_plans.index')->with([
...
//        dd($plan);
        return view('plan.roster_plans.view', compact('title', 'section', 'sub_section', 'section_url', 'plan'));
    }
    public function edit($id){
        ...
        $plan = $this->planServices->getPlanById($id,RosterPlan::class );
        $shifts = ShiftPlan::all();
        return view('plan.roster_plans.form', compact('title', 'section', 'sub_section', 'section_url', 'plan', 'shifts'));
    }
