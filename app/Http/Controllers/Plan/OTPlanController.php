...
use App\Imports\Plan\OTPlansImport;
...
class OTPlanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return view('plan.ot_plans.search_results', compact('plans'))->render();
        }
//        dd($plans);
        return view('plan.ot_plans.index', compact('title', 'section', 'sub_section', 'plans'));
    }
    ...
    public function create()
    {
        ...
        $section = 'OT Plans';
        $sub_section = 'Create';
        $section_url = route('plan.ot_plans.index');
        return view('plan.ot_plans.form', compact('title', 'section', 'sub_section', 'section_url'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('plan.ot_plans.index')->with([
    ...
    public function show($id)
    {
        ...
        return view('plan.ot_plans.view', compact('title', 'section', 'sub_section', 'section_url', 'plan'));
    }
    ...
    public function edit($id)
    {
        ...
        $section_url = route('plan.ot_plans.index');
        $plan = $this->planServices->getPlanById($id, OTPlan::class);
        return view('plan.ot_plans.form', compact('title', 'section', 'sub_section', 'section_url', 'plan'));
    }
