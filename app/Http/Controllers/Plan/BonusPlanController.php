...
use App\Imports\Plan\BonusPlansImport;
...
class BonusPlanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return view('plan.bonus_plans.search_results', compact('plans'))->render();
        }
//        dd($plans);
        return view('plan.bonus_plans.index', compact('title', 'section', 'sub_section', 'plans'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('plan.bonus_plans.index')->with([
    ...
    public function show($id)
    {
        ...
        return view('plan.bonus_plans.view', compact('title', 'section', 'sub_section', 'section_url', 'plan'));
    }
