...
use App\Imports\AllowancePlansImport;
use App\Models\AllowancePlan;
...
class AllowancePlanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return view('plans.allowance_plans.search_results', compact('plans'))->render();
        }
        return view('plans.allowance_plans.index', compact('title', 'section', 'sub_section', 'plans'));
    }
    ...
    public function create()
    {
        ...
        $sub_section = 'Create';
        $section_url = route('plans.allowance_plans.index');
        return view('plans.allowance_plans.form', compact('title', 'section', 'sub_section', 'section_url'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('plans.allowance_plans.index')->with([
    ...
    public function show($id)
    {
        ...
        return view('plans.allowance_plans.view', compact('title', 'section', 'sub_section', 'section_url', 'plan'));
    }
    ...
    public function edit($id)
    {
        ...
        $section_url = route('plans.allowance_plans.index');
        $plan = $this->planServices->getPlanById($id, AllowancePlan::class);
        return view('plans.allowance_plans.form', compact('title', 'section', 'sub_section', 'section_url', 'plan'));
    }
