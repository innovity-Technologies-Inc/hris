...
class EmployeeProfileController extends Controller
{
    ...
    public function index(Request $request, FlexSearch $flexsearch){
        ...
        if ($request->ajax()) {
            return view('employee.partials.search_results', compact('employees', 'roles'))->render();
        }
        return view('employee.index', compact('employees', 'title', 'section', 'sub_section', 'roles'));
    ...
    public function generalInfoCreate(){
        ...
        $roles = $this->empServices->getRoles();
        return view('employee.general_informations.form', compact('title', 'section', 'sub_section', 'section_url', 'roles'));
    }
    ...
    public function generalInfoStore(EmployeeGeneralInfoRequest $request){
        ...
        return redirect()->route('employee.profile.general_informations', $employee->id)->with([
...
//    dd($request->all());
    ...
    public function showOfficeInfo($id){
        ...
        $employee_office_info = \App\Models\Employee\EmployeeOfficeInfo::where('employee_id', $id)->first();
...
//    dd($request->all());
    ...
    public function bulkEmployeeImportSections(){
        ...
        $sub_section = 'Import';
        $section_url = route('employee.index');
        return view('employee.bulk_uploads.form', compact('title', 'section', 'sub_section', 'section_url'));
    }
