...
class EmployeeEducationExperienceTrainingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('employee.profile.education_information', $employeeEduData->employee_id)->with([
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('employee.profile.education_information', $employee)->with([
