...
class TofsilsController extends Controller
{
    public function index(Request $request, FlexSearch $flexsearch){
        ...
        if ($request->ajax()) {
            return view('company.tofsil.search_results', compact('tofsils'))->render();
        }
        return view('company.tofsil.index', compact('title', 'section', 'sub_section', 'tofsils'));
    }
    ...
    public function create(){
        ...
        $sub_section = 'Add';
        return view('company.tofsil.form', compact('title', 'section', 'sub_section', 'section_url'));
    }
    ...
    public function edit($id){
        ...
        return view('company.tofsil.form', compact('title', 'section', 'sub_section', 'section_url', 'tofsil'));
    }
