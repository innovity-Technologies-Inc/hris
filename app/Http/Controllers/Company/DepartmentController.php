...
class DepartmentController extends Controller
{
    public function index(Request $request, FlexSearch $flexsearch)
    {
        ...
        if ($request->ajax()) {
            return view('company.departments.search_results', compact('departments'))->render();
        }
        $divisions = Division::all();
        return view('company.departments.index', compact('title', 'section', 'sub_section', 'departments', 'divisions'));
    }
    ...
    public function create()
    {
        ...
        return view('company.departments.form', compact('divisions', 'companies', 'locations'));
    }
    ...
    public function edit($id)
    {
        ...
        $locations = \App\Models\Company\CompanyLocation::all();
        return view('company.departments.form', compact('department', 'divisions', 'companies', 'locations'));
    }
