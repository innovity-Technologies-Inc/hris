...
class BanksController extends Controller
{
    public function index(Request $request, FlexSearch $flexsearch){
        ...
        if ($request->ajax()) {
            return view('company.bank.search_results', compact('banks'))->render();
        }
        return view('company.bank.index', compact('title', 'section', 'sub_section', 'banks'));
    }
    ...
    public function create(){
        ...
        $sub_section = 'Add';
        return view('company.bank.form', compact('title', 'section', 'sub_section', 'section_url'));
    }
    ...
    public function edit($id){
        ...
        $sub_section = 'Edit';
        $bank = Bank::find($id);
        return view('company.bank.form', compact('title', 'section', 'sub_section', 'section_url', 'bank'));
    }
