...
class BankAccountsController extends Controller
{
    public function index(Request $request, FlexSearch $flexsearch){
        ...
        if ($request->ajax()) {
            return view('company.bank_accounts.search_results', compact('bank_accounts'))->render();
        }
        return view('company.bank_accounts.index', compact('title', 'section', 'sub_section', 'bank_accounts'));
    }
    ...
    public function create(){
        ...
        return view('company.bank_accounts.form', compact('title', 'section', 'sub_section', 'section_url', 'banks', 'branches'));
    }
