...
class HolidayController extends Controller
{
    public function index(Request $request, FlexSearch $flexsearch)
    {
        ...
        if ($request->ajax()) {
            return view('company.holidays.search_results', compact('holidays'))->render();
        }
        return view('company.holidays.index', compact('title', 'section', 'sub_section', 'holidays'));
    }
    ...
    public function create()
    {
        ...
        $section = 'Company Setup';
        $sub_section = 'Holidays';
        return view('company.holidays.form', compact('title', 'section', 'sub_section'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('company.holidays.form', compact('title', 'section', 'sub_section', 'holiday'));
    }
    ...
    public function calendar()
    {
        ...
        $section = 'Company Setup';
        $sub_section = 'Holidays';
        return view('company.holidays.calendar', compact('title', 'section', 'sub_section'));
    }
