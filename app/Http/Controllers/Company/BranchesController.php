...
class BranchesController extends Controller
{
    public function index(Request $request, FlexSearch $flexsearch){
        ...
        if ($request->ajax()) {
            return view('company.branch.search_results', compact('branches'))->render();
        }
        return view('company.branch.index', compact('title', 'section', 'sub_section', 'branches'));
    }
    ...
    public function create(){
        ...
        return view('company.branch.form', compact('title', 'section', 'sub_section', 'section_url', 'banks'));
    }
    ...
    public function edit($id){
        ...
        $banks = Bank::all()->sortBy('name');
        return view('company.branch.form', compact('title', 'section', 'sub_section', 'section_url', 'branch', 'banks'));
    }
