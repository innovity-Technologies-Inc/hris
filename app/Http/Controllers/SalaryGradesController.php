...
class SalaryGradesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('company_setup.salary_grade.form', compact('title', 'section', 'sub_section', 'section_url', 'tofsils'));
    }
    ...
    public function edit($id)
    {
        ...
        $tofsils = Tofsil::all()->sortBy('name');
        return view('company_setup.salary_grade.form', compact('title', 'section', 'sub_section', 'section_url', 'salary_grade', 'tofsils'));
    }
