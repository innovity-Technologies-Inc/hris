    ...
    public function salaryProcess($data, $processId = null)
    {
        ...
        return DB::transaction(function () use ($data, $processId) {
            ...
            foreach ($employees as $employee) {
                ...
                $offDayWorkSalary = $this->offDayWorkSalary($employee->id, $employeeSalary, $employeeAttendance->whereIn('shift_type', ['paid-off', 'paid-offday', 'Paid-Off-Day', 'Off-Day']), $totalMonthlyHours, $workingHoursPerDay, $frequency, $workingDaysPerCycle);
                ...
                $employeeData[] = [
                    ...
                    'offday_work_count' => $employeeAttendance->whereIn('shift_type', ['paid-off', 'paid-offday', 'Paid-Off-Day', 'Off-Day'])->count(),
