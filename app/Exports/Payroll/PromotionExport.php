...
class PromotionExport implements FromCollection, WithHeadings, WithMapping
{
    protected $records;
    ...
    public function map($row): array
    {
        ...
        return [
            ...
            $row->getPreviousDesignation?->company_designation ?? 'N/A',
            $row->getNewDesignation?->company_designation ?? 'N/A',
