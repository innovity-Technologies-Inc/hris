...
test('it processes arrear using central approval engine sequential workflow', function () {
    $this->withoutExceptionHandling();

    $hrRole = Role::firstOrCreate(['name' => 'HR Manager', 'guard_name' => 'web']);
    
    $workflow = Workflow::create([
        'name' => 'Arrear Approval Workflow',
        'module' => 'arrear',
        'type' => 'sequential',
        'total_steps' => 1,
        'is_active' => true
    ...
    expect($process->total_amount)->toEqual(7500.00);

    $item = Arrear::latest()->first();
