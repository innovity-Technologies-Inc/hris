        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm rounded">
                <div class="card-header">
                    <h5 class="card-title mb-0">New Career Movement Application</h5>
                </div>
                <div class="card-body">
                    <form id="transferForm" enctype="multipart/form-data">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-5 border-end pe-lg-5">
                                <div class="mb-4">
                                    <h6 class="fw-bold text-primary mb-3 border-bottom pb-2">Employee Selection</h6>
                                    <div class="mb-3">
                                ...
                                <div class="mt-4 p-3 bg-primary bg-opacity-10 rounded border border-primary-subtle">
                            ...
                            <div class="col-lg-7 ps-lg-5">
                                <h6 class="fw-bold text-primary mb-3 border-bottom pb-2">Requested Information</h6>
                                ...
                                <div class="mt-4">
                                    ...
                                    <textarea name="remarks" id="remarks" rows="4" class="form-control" placeholder="Explain the reason for this career movement..."></textarea>
                                </div>
                                ...
                                <div class="mt-5 d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i style="height: 12px; width: 12px" data-feather="save"></i> Submit Application
                                    </button>
                                </div>
                            </div>
                        </div>
