                ...
                <div class="modal-body p-4">
                    ...
                    <div class="alert alert-danger border-0 shadow-sm d-flex align-items-start" role="alert">
                        ...
                        <div>
                            ...
                            <p class="mb-2">Please follow the bulk movement upload format carefully to ensure
                                successful data import.</p>
                            <ul class="mb-0 ps-3">
                                <li>Download the CSV or Excel template before uploading</li>
                                <li>Do not modify column headers (employee_id, from_date, to_date, source_address,
                                    destination_address, covered_distance, ta_plan_id, da_plan_id, reason, status)</li>
                                <li>Ensure all required fields are filled correctly</li>
                                <li>Use valid Employee System IDs or Applicant IDs from the system</li>
                                <li>Date format must be YYYY-MM-DD HH:MM:SS (e.g., 2025-12-20 09:00:00)</li>
                                <li>Covered distance must be in kilometers (KM)</li>
                                <li>Use valid TA Plan IDs and DA Plan IDs from the system</li>
                                <li>Status must be: pending, approved, rejected, or completed</li>
                                <li>Ensure to_date is after or equal to from_date</li>
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">Get the official template with sample data to fill
                                        employee movement information</p>
                                </div>
                                <div class="d-flex gap-2">
                                    <a href="{{ asset('samples/movement_import_template.html') }}"
                                        class="btn btn-success text-decoration-none"
                                        download="movement_import_template.html">
                                        <i class="mdi mdi-file-excel me-1"></i> Excel Format
                                    </a>
                                    <a href="{{ asset('assets/csv/movement.csv') }}"
                                        class="btn btn-info text-white text-decoration-none"
                                        download="movement_import_template.csv">
                        ...
                        <div class="card-body p-3">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <p class="mb-0 fw-semibold" id="fileName">employee_movement.xlsx</p>
