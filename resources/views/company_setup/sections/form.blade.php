                            ...
                            <form
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <label for="name" class="form-label">Section Name <span
                                        ...
                                        <select class="form-select select2_list" name="company_id" id="company_id" required>
                                            ...
                                            @foreach ($companies as $item)
                                                <option value="{{ $item->id }}"
                                                    @if (isset($section) && $section->company_id == $item->id) selected @endif>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select id="location_id" class="form-select select2_list" name="location_id"
                                            ...
                                            @foreach ($locations as $location)
                                                <option value="{{ $location->id }}"
                                                    {{ isset($section) && $section->location_id == $location->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <label for="department_id" class="form-label">Department <span
                                                class="text-danger">*</span></label>
                                        <select id="department_id" class="form-select select2_list" name="department_id"
                                            required>
