...
@section('content')
            ...
            <div class="card">
                        ...
                        <div class="col-12">
                            <div class="input-group input-group-md">
                                <input type="text" class="form-control border-end-0" id="keywordSearch" name="keyword"
                                    placeholder="Search salary grades by keyword" aria-label="Keyword Search">
                ...
                <div class="card-body">
                    <div class="table-responsive" id="search-result">
                        @include('company_setup.salary_grade.search_results')
                        <div class="mt-3">
                            {{ $salary_grades->links() }}
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            function fetchData(url = "{{ route('salary_grades.index') }}") {
