        ...
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-header bg-primary text-white border-0">
                <h5 class="modal-title fw-semibold" id="bulkUploadModalLabel">
                    <i class="mdi mdi-file-upload-outline me-2"></i>Bulk Plan Upload - <span id="activeSectionName">Meal
                        Plan</span>
                </h5>
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="alert alert-info border-0 shadow-sm mb-3" id="activeSectionBadge">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <span id="activeSectionText">Meal Plan</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-danger border-0 shadow-sm d-flex align-items-start" role="alert">
                        ...
                        <div>
                            ...
                            <p class="mb-2">Please follow the bulk plan upload format carefully to ensure successful
                                data import.</p>
                            <ul class="mb-0 ps-3">
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">Get the official template to fill plan information
                                    </p>
                                </div>
                        ...
                        <div class="card-body p-3">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <p class="mb-0 fw-semibold" id="fileName">plans.xlsx</p>
