...
@section('content')
    <div class="container-fluid mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <!-- Back Button -->
            <div>
                <a href="{{ route('plans.bonus_plans.index') }}" class="btn btn-secondary">
            ...
            <div class="d-flex gap-2">
                <!-- Edit Button -->
                <a href="{{ route('plans.bonus_plans.edit', $plan->id) }}" class="btn btn-primary">
                    <i class="mdi mdi-pencil me-1"></i>Edit
                </a>

                <!-- Delete Button -->
                <form action="{{ route('plans.bonus_plans.delete', $plan->id) }}" method="POST"
