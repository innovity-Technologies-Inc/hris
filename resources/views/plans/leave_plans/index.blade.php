        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <a type="button" class="btn btn-warning btn-sm" href="{{ route('plans.leave_plans.create') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a type="button" class="btn btn-primary btn-sm"
                                                href="{{ route('plans.leave_plans.show', $item->id) }}" title="View">
                                                <i style="height: 12px; width: 12px" data-feather="eye"></i>
                                            </a>

                                            <a type="button" class="btn btn-warning btn-sm"
                                                href="{{ route('plans.leave_plans.edit', $item->id) }}" title="Edit">
                                                <i style="height: 12px; width: 12px" data-feather="edit"></i>
                                            </a>

                                            <form action="{{ route('plans.leave_plans.delete', $item->id) }}" method="POST"
