...
@section('content')
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <a type="button" class="btn btn-warning btn-sm" href="{{ route('plans.da_plans.create') }}">
                        ...
                        <div class="col-12">
                            <div class="input-group input-group-md">
                                <input type="text" class="form-control border-end-0" id="keywordSearch" name="keyword"
                                    placeholder="Search Dining Allowance plans by name" aria-label="Keyword Search">
                ...
                <div class="card-body" id="search-result">
                    @include('plans.da_plans.search_results')
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchData(url = "{{ route('plans.da_plans.index') }}") {
            ...
            $('#resetFilters').on('click', function() {
                ...
                window.location.href = "{{ route('plans.da_plans.index') }}";
            });
