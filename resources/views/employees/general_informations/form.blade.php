                            ...
                            <div class="row">
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number"
                                            ...
                                            max="11" value="{{ old('height_inches') }}">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        id="children_count" name="children_count" value="{{ old('children_count', 0) }}"
                                        min="0">
                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('present_address.line_1') }}">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('present_address.village') }}">
                            ...
                            <div class="row">
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('present_address.post_office') }}">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('present_address.division') }}">
                            ...
                            <div class="row">
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('present_address.zip_code') }}">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('present_address.state') }}">
                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('permanent_address.line_1') }}">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('permanent_address.village') }}">
                            ...
                            <div class="row">
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('permanent_address.post_office') }}">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('permanent_address.division') }}">
                            ...
                            <div class="row">
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('permanent_address.zip_code') }}">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('permanent_address.state') }}">
                            ...
                            <div class="row">
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('reference_address.emp_id') }}">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('reference_address.reference_name') }}">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('reference_address.reference_designation') }}">
                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('reference_address.line_1') }}">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('reference_address.village') }}">
                            ...
                            <div class="row">
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('reference_address.post_office') }}">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('reference_address.district') }}">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('reference_address.division') }}">
                            ...
                            <div class="row">
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('reference_address.zip_code') }}">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('reference_address.state') }}">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('reference_address.country') }}">
                            ...
                            <div class="row">
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="tel"
                                        ...
                                        value="{{ old('reference_address.phone') }}">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="tel"
                                        ...
                                        value="{{ old('reference_address.mobile') }}">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="email"
                                        ...
                                        value="{{ old('reference_address.email') }}">
