...
@section('content')
    ...
    @endif
        <div class="mt-4">
            ...
            <form class="" method="POST" enctype="multipart/form-data" action="{{isset($employee_nominee_info) ? route('employees.nominee_information.update', $employee_nominee_info->id) : route('employees.nominee_information.store') }}">
                @if(isset($employee_nominee_info))
                    @method('PUT')
                @endif
                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nominee_name') is-invalid @enderror"
                                               id="nominee_name" name="nominee_name" value="{{ isset($employee_nominee_info) ? $employee_nominee_info->full_name : old('nominee_name') }}" required>
                                        @error('nominee_name')
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        ...
                                        <select class="form-select @error('gender') is-invalid @enderror"
                                            ...
                                            <option value="male" {{ old('gender') == 'male' ? 'selected' : '' }} {{isset($employee_nominee_info) && $employee_nominee_info->gender == 'male' ? 'selected' :''}}>Male</option>
                                            <option value="female" {{ old('gender') == 'female' ? 'selected' : '' }} {{isset($employee_nominee_info) && $employee_nominee_info->gender == 'female' ? 'selected' :''}}>Female</option>
                                            <option value="other" {{ old('gender') == 'other' ? 'selected' : '' }} {{isset($employee_nominee_info) && $employee_nominee_info->gender == 'other' ? 'selected' :''}}>Other</option>
                                        </select>
                                        @error('gender')
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="row">
                                    <div class="col-lg-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('father_name') is-invalid @enderror"
                                               id="father_name" name="father_name" value="{{ isset($employee_nominee_info) ? $employee_nominee_info->father_name :  old('father_name') }}">
                                        @error('father_name')
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
