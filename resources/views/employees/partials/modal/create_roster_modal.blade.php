    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="createRosterPlanForm" method="POST" action="#">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" id="modal_roster_effective_from" name="effective_from"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" id="modal_roster_effective_to" name="effective_to"
