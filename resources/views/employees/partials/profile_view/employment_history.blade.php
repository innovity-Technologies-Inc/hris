            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center">
                    ...
                    @can('employee-management.edit')
                        <a href="{{ route('employees.employment_history.edit', $employee->id) }}" class="btn btn-sm btn-outline-primary">
        ...
        @else
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body text-center py-5">
                    ...
                    @can('employee-management.create')
                        <a href="{{ route('employees.employment_history.create', $employee->id) }}" class="btn btn-primary mt-2">
