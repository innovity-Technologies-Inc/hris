            ...
            <div class="card">
                <div class="card-body pt-0">
                    <ul class="nav nav-underline border-bottom pt-2" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link p-2" id="identification_tab" data-bs-toggle="tab" href="#identification" role="tab">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="alert alert-info">
                                        ...
                                        <strong>Employee:</strong> John Doe (EMP-2024-001) | <strong>Nominee Ratio:</strong> 100%
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="card bg-light border-0">
                                        <div class="card-body text-center">
                                            <img src="/path/to/nominee-photo.jpg" alt="Nominee Photo" class="img-thumbnail" style="max-width: 200px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="card bg-light border-0">
                                        <div class="card-body">
                                            ...
                                            <p class="mb-0"><i class="mdi mdi-information-outline me-2"></i>Preferred contact method: Mobile</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
