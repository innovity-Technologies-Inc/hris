...
@section('content')
    ...
    <div class="mt-4">
        <form id="employeeForm" method="POST" action={{ isset($employeeData) ? route('employee.education-experience-training.update', $employeeData->id) : route('employee.education-experience-training.store') }}>
                                ...
                                <div class="education-row border rounded p-3 mb-3 bg-light" data-row="0">
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="educations[0][education_title]" placeholder="e.g., Bachelor of Science" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Institute <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="educations[0][institute]" placeholder="e.g., University of Dhaka" required>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control" name="educations[0][passing_year]" placeholder="e.g., 2020" required>
                                        </div>
                                        <div class="col-md-3">
                                ...
                                <div class="experience-row border rounded p-3 mb-3 bg-light" data-row="0">
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="experiences[0][company]" placeholder="e.g., ABC Corporation Ltd" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Designation <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="experiences[0][designation]" placeholder="e.g., Senior Software Engineer" required>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="date" class="form-control" name="experiences[0][date_from]" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Date To <span class="text-danger">*</span></label>
                                            <input type="date" class="form-control" name="experiences[0][date_to]" required>
                                        </div>
                                        <div class="col-md-4">
                                ...
                                <div class="training-row border rounded p-3 mb-3 bg-light" data-row="0">
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="trainings[0][training_title]" placeholder="e.g., Advanced Laravel Development" required>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control" name="trainings[0][from_date]" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">To Date <span class="text-danger">*</span></label>
                                            <input type="date" class="form-control" name="trainings[0][to_date]" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="mdi mdi-content-save me-1"></i> Save Information
                        </button>
                    </div>
                </div>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('addEducationRow').addEventListener('click', function() {
                ...
                newRow.innerHTML = `
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <label class="form-label">Education Title <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="educations[${educationRowCount}][education_title]" placeholder="e.g., Bachelor of Science" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Institute <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="educations[${educationRowCount}][institute]" placeholder="e.g., University of Dhaka" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Group/Major</label>
                        ...
                        <div class="col-md-3">
                            <label class="form-label">Passing Year <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="educations[${educationRowCount}][passing_year]" placeholder="e.g., 2020" required>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">GPA/CGPA</label>
            ...
            document.getElementById('addExperienceRow').addEventListener('click', function() {
                if (experienceRowCount >= maxRows) {
                    alert('Maximum 5 experience rows allowed');
                    return;
                }
                ...
                newRow.innerHTML = `
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <label class="form-label">Company <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="experiences[${experienceRowCount}][company]" placeholder="e.g., ABC Corporation Ltd" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Designation <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="experiences[${experienceRowCount}][designation]" placeholder="e.g., Senior Software Engineer" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Department</label>
                        ...
                        <div class="col-md-4">
                            <label class="form-label">Date From <span class="text-danger">*</span></label>
                            <input type="date" class="form-control" name="experiences[${experienceRowCount}][date_from]" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Date To <span class="text-danger">*</span></label>
                            <input type="date" class="form-control" name="experiences[${experienceRowCount}][date_to]" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Duration</label>
            ...
            document.getElementById('addTrainingRow').addEventListener('click', function() {
                if (trainingRowCount >= maxRows) {
                    alert('Maximum 5 training rows allowed');
                    return;
                }
                ...
                newRow.innerHTML = `
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <label class="form-label">Training Title <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="trainings[${trainingRowCount}][training_title]" placeholder="e.g., Advanced Laravel Development" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Course Name</label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label">From Date <span class="text-danger">*</span></label>
                            <input type="date" class="form-control" name="trainings[${trainingRowCount}][from_date]" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">To Date <span class="text-danger">*</span></label>
                            <input type="date" class="form-control" name="trainings[${trainingRowCount}][to_date]" required>
                        </div>
                    </div>
                `;
