...
@section('content')
    @if (Route::currentRouteNamed('employees.employment_history.create'))
    ...
    <div class="mt-4">
        ...
        <form id="employmentHistoryForm" method="POST"
            action="{{ isset($historyData) ? route('employees.employment_history.update', $employee->id) : route('employees.employment_history.store') }}">
