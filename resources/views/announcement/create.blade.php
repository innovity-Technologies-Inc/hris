                ...
                <div class="card-body p-4">
                    <form id="announcementForm" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <!-- Note: We use a custom id to avoid conflicts and initialize it with summernote -->
                        ...
                        <!-- Attachment -->
                        <div class="mb-4">
                            <label for="attachment" class="form-label fw-semibold">Attachment File <span class="text-muted">(Optional - PDF, Word, Excel, Images up to 10MB)</span></label>
...
<script>
    $(document).ready(function() {
        ...
        document.getElementById('announcementForm').addEventListener('submit', function(e) {
            ...
            axios.post('{{ route('announcements.store') }}', formData, {
                headers: {
