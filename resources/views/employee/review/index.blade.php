        ...
        <div class="card border-0 shadow-sm rounded">
            ...
            <div class="card-body">
                <div id="tableContainer">
                    @include('employee.review.partials.table', ['employees' => $employees])
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    function fetchResults(url = "{{ route('employee.review.index') }}") {
    ...
    $('#resetBtn').on('click', function() {
        searchForm[0].reset();
        window.location.href = "{{ route('employee.review.index') }}";
    });
