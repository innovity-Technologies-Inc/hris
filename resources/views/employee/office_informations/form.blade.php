...
@section('content')
    <div class="mt-4">
        ...
        <form class="" method="POST" enctype="multipart/form-data" action="{{isset($employee_office_info) ? route('employee.office_informations.update', $employee_office_info->id) : route('employee.office_informations.store') }}">
