...
@section('content')
                            ...
                            <div class="card h-100 border shadow-sm professional-card">
                                <div class="card-body p-4">
                                    ...
                                    <button type="button"
                                            ...
                                            data-form-action="{{ route('employee.general_informations.import') }}"
                            ...
                            <div class="card h-100 border shadow-sm professional-card">
                                <div class="card-body p-4">
                                    ...
                                    <button type="button"
                                            ...
                                            data-form-action="{{ route('employee.education_information.import') }}"
                            ...
                            <div class="card h-100 border shadow-sm professional-card">
                                <div class="card-body p-4">
                                    ...
                                    <button type="button"
                                            ...
                                            data-form-action="{{ route('employee.office_informations.import') }}"
                            ...
                            <div class="card h-100 border shadow-sm professional-card">
                                <div class="card-body p-4">
                                    ...
                                    <button type="button"
                                            ...
                                            data-form-action="{{ route('employee.eligible_plans.import') }}"
                            ...
                            <div class="card h-100 border shadow-sm professional-card">
                                <div class="card-body p-4">
                                    ...
                                    <button type="button"
                                            ...
                                            data-section-number="6"
                                            data-form-action="{{ route('employee.salary_breakdown.import') }}"
                            ...
                            <div class="card h-100 border shadow-sm professional-card">
                                <div class="card-body p-4">
                                    <div class="d-flex align-items-start mb-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="mb-1 fw-semibold text-dark">Account Details</h6>
                                            <p class="text-muted small mb-0" style="font-size: 0.813rem;">Bank Account Details</p>
                                        </div>
                                    </div>
                                    <button type="button"
                                            class="btn btn-outline-dark btn-sm w-100 text-uppercase fw-semibold"
                                            ...
                                            data-bs-toggle="modal"
                                            data-bs-target="#bulkUploadModal"
                                            data-section="bank-account-details"
                                            data-section-name="Bank Account Details"
                                            data-section-number="7"
                                            data-form-action="{{ route('employee.bank_accounts.import') }}"
    ...
    <!-- Include the modal -->
    @include('employee.bulk_uploads.import')
