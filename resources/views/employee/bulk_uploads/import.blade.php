        ...
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-header bg-primary text-white border-0">
                <h5 class="modal-title fw-semibold" id="bulkUploadModalLabel">
                    <i class="mdi mdi-file-upload-outline me-2"></i>Bulk Employee Upload - <span id="activeSectionName">General Information</span>
                </h5>
                ...
                <div class="alert alert-info border-0 shadow-sm mb-3" id="activeSectionBadge">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <span id="activeSectionText">General Information</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="#" class="btn btn-info text-white text-decoration-none" id="downloadCsv">
