    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content glass-modal">
            ...
            <div class="modal-body p-4" id="detailedViewModalBody">
                ...
                <!-- Content State -->
                <div id="detailedContent" class="d-none container-fluid px-0">
                    
                    <!-- 1. Header Information (Full Row) -->
                    <div class="row mx-0">
                        <div class="col-12 px-0">
                            <div class="card border shadow-none mb-3 w-100">
                                <div class="card-body">
                    ...
                    <div class="hando-main-sections">
                        ...
                        <div class="row mx-0">
                            <div class="col-12 px-0">
                                <div id="section_office_info_card" class="card border shadow-none mb-3 w-100">
                                    <div class="card-header bg-light py-2">
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12"><hr class="my-1"></div>
                                            <div class="col-md-2"><label class="data-label">OT Allowed</label><span id="detailed_ot_allowed"></span></div>
                                            <div class="col-md-2"><label class="data-label">PF Eligible</label><span id="detailed_pf_eligible"></span></div>
                                            <div class="col-md-2"><label class="data-label">Transport Eligible</label><span id="detailed_transport_eligible"></span></div>
                                            <div class="col-md-2"><label class="data-label">Gratuity Eligible</label><span id="detailed_gratuity_eligible"></span></div>
                                            <div class="col-md-2"><label class="data-label">Can Apply Loan</label><span id="detailed_can_loan"></span></div>
                                            <div class="col-md-2"><label class="data-label">Can Apply Advance</label><span id="detailed_can_advance"></span></div>
                        ...
                        <div class="row mx-0">
                            <div class="col-12 px-0">
                                <div id="section_education" class="card border shadow-none mb-3 d-none w-100">
                                    <div class="card-header bg-light py-2">
                        ...
                        <div class="row mx-0">
                            <div class="col-12 px-0">
                                <div id="section_training" class="card border shadow-none mb-3 d-none w-100">
                                    <div class="card-header bg-light py-2">
                        ...
                        <div class="row mx-0">
                            <div class="col-12 px-0">
                                <div id="section_history" class="card border shadow-none mb-3 d-none w-100">
                                    <div class="card-header bg-light py-2">
                        ...
                        <div class="row mx-0">
                            <div class="col-12 px-0">
                                <div id="section_nominee" class="card border shadow-none mb-3 d-none w-100">
                                    <div class="card-header bg-light py-2">
                        ...
                        <div class="row mx-0">
                            <div class="col-12 px-0">
                                <div id="section_bank" class="card border shadow-none mb-3 d-none w-100">
                                    <div class="card-header bg-light py-2">
                        ...
                        <div class="row mx-0">
                            <div class="col-12 px-0">
                                <div id="section_salary" class="card border shadow-none mb-3 d-none w-100">
                                    <div class="card-header bg-light py-2">
