        ...
        <div class="modal-content glass-modal">
            ...
            <div class="modal-body p-4" id="detailedViewModalBody">
                ...
                <div id="modalContent" class="d-none">
                    ...
                    <!-- 1. Header Information (Full Width) -->
                    <div class="row">
                        <div class="col-12">
                    ...
                    <!-- 2. Personal Information (Full Width) -->
                    <div class="row">
                        <div class="col-12">
                            <div class="card border shadow-none mb-3">
                    ...
                    <!-- 3. Birth & Identification Documents (Full Width) -->
                    <div class="row">
                        <div class="col-12">
                            <div class="card border shadow-none mb-3">
                                <div class="card-header bg-light py-2">
                    ...
                    <!-- 6. Permanent Address (Full Width) -->
                    <div class="row">
                        <div class="col-12">
                            <div class="card border shadow-none mb-3">
                                <div class="card-header bg-light py-2">
                    ...
                    <!-- 7. Reference Information (Full Width) -->
                    <div class="row">
                        <div class="col-12">
                            <div class="card border shadow-none mb-3">
                                <div class="card-header bg-light py-2">
                    ...
                    <!-- 8. Office Information (Full Width) -->
                    <div class="row">
                        <div class="col-12">
...
<style>
    ...
    /* Specific classes for data presentation to avoid affecting header icons */
