<div class="row">
    <div class="col-12">
        @if (auth()->user()->user_type === \App\Enums\UserType::Employee && ((isset($employee_nominee_info) && $employee_nominee_info->status === 'incomplete') || empty($employee_nominee_info)))
                    ...
                    <div class="col-lg-6 col-md-8 col-sm-10">
                        <div class="card shadow-sm border-0 mt-5 mb-5">
                            <div class="card-body text-center p-5">
                                ...
                                <!-- Action Button -->
                                @can('employee-management.create')
                                <a href="{{ route('employee.nominee_information.create', $employee->id) }}"
