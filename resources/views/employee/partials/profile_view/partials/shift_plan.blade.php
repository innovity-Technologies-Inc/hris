            ...
            @can('employee-management.edit')
                <div>
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#createShiftPlanModal">
                    ...
                    @if(auth()->user()->user_type !== \App\Enums\UserType::Employee)
                        @can('employee-management.edit')
                            <div class="position-absolute top-0 end-0 mt-2 me-3">
                                <form
                                    action="{{ route('employee.profile.plans.remove', ['id' => $activeShiftPLan->id, 'type' => 'shift-plans']) }}"
                                    method="post">
                                    @csrf
                                    @method('put')
...
@include('employee.partials.modal.create_shift_modal')
