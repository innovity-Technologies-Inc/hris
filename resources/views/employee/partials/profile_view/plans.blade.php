                ...
                <ul class="nav nav-underline border-bottom pt-2  mb-3" id="plan-tabs" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link @if($type == 'offday-plans') active @endif p-2 ajax-tab"
                           data-url="{{route('employee.profile.plans', ['id' => $employee->id, 'type' => 'offday-plans'])}}">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link @if($type == 'bonus-plans') active @endif p-2 ajax-tab"
                           data-url="{{route('employee.profile.plans', ['id' => $employee->id, 'type' => 'bonus-plans'])}}">
                            <span class="d-none d-sm-block">Bonus & Reward Plan</span>
                        </a>
                    </li>

                    <li class="nav-item" role="presentation">
                        <a class="nav-link @if($type == 'leave-plans') active @endif p-2 ajax-tab"
                           data-url="{{route('employee.profile.plans', ['id' => $employee->id, 'type' => 'leave-plans'])}}">
...
{{--                Tab Skeleton--}}
                ...
                <div id="tabContentWrapper" class="tab-content text-muted">
                    @if($type == 'meal-plans')
                        @include('employee.partials.profile_view.partials.meal_plan')

                    @elseif($type == 'shift-plans')
                        @include('employee.partials.profile_view.partials.shift_plan')

                    @elseif($type == 'roster-plans')
                        @include('employee.partials.profile_view.partials.roster_plan')

                    @elseif($type == 'ot-plans')
                        @include('employee.partials.profile_view.partials.ot_plan')

                    @elseif($type == 'offday-plans')
                        @include('employee.partials.profile_view.partials.offday_plan')

                    @elseif($type == 'bonus-plans')
                        @include('employee.partials.profile_view.partials.bonus_plan')

                    @elseif($type == 'leave-plans')
                        @include('employee.partials.profile_view.partials.leave_plan')
