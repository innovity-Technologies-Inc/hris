...
<div class="row">
    <div class="col-12">
        <form action="{{ isset($role) ? route('setting.roles.update', $role->id) : route('setting.roles.store') }}" method="POST">
            @csrf
            @if(isset($role))
                @method('PUT')
            @endif
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-footer bg-light d-flex justify-content-end gap-2">
                    <a href="{{ route('setting.roles.index') }}" class="btn btn-secondary">Cancel</a>
