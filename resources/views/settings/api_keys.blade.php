    ...
    <div class="py-4" style="max-width: 1000px; margin: 0 auto;">
        ...
        <div class="card shadow-lg border-0 rounded-4">
            ...
            <div class="card-body p-4 p-md-5">
                <form id="apiKeysForm" action="{{ route('settings.api_keys.save') }}" method="POST">
                    @csrf
                    ...
                    <div class="d-flex justify-content-end gap-3">
                        <a href="{{ route('dashboard') }}" class="btn btn-lg btn-outline-secondary px-4 px-md-5 rounded-3">
