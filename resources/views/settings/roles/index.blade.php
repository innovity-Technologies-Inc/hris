    ...
    <div class="col-12">
        <div class="card shadow-sm border-0 rounded">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('settings.roles.create') }}" class="btn btn-light btn-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a href="{{ route('settings.roles.edit', $role->id) }}" class="btn btn-info btn-sm" title="Edit Permissions">
                                            <i style="height: 12px; width: 12px" data-feather="edit-2"></i>
                                        </a>
                                        @if($role->name !== 'Super Admin')
                                        <form action="{{ route('settings.roles.destroy', $role->id) }}" method="POST" class="d-inline confirmDelete">
                                            @csrf
                                            @method('DELETE')
