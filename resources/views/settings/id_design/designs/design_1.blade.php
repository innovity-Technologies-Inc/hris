...
// Get actual settings from database, with fallback dummy data
$dummySetting = (object) [
...
// Use employee's company info or fallback to system settings
    $set = (object) [
        'company_name' =>
            $companyName ?? (\App\Models\GeneralSetting::first()?->company_name ?? $dummySetting->company_name),
        'website' => \App\Models\GeneralSetting::first()?->website ?? $dummySetting->website,
        'contact_phone' => \App\Models\GeneralSetting::first()?->contact_phone ?? $dummySetting->contact_phone,
        'logo_light' =>
            $currentCompany && $currentCompany->logo
                ? $currentCompany->logo
                : \App\Models\GeneralSetting::first()?->logo_light ?? $dummySetting->logo_light,
    ];
