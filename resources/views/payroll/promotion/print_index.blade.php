...
<head>
    ...
    <title>Employee Promotion Logs - Print</title>
    <style>
        @page {
            size: A4 landscape;
            margin: 15mm 10mm;
...
<body>
    ...
    <div class="report-header">
        <h1>Employee Promotion Sheet</h1>
        <p>List of all employee designations promotions, salary updates, and adjustments</p>
        <p><strong>Report Date:</strong> {{ date('l, F j, Y') }}</p>
    </div>

    <div class="report-info">
        <div><strong>Total Promotions:</strong> {{ count($records) }}</div>
        @if(request('keyword'))
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width:10%;">Increase Amount</th>
