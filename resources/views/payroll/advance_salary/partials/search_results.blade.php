<table class="table table-bordered table-hover mb-0">
    ...
    @forelse($data as $item)
        <tr>
            ...
            <td class="text-center" style="width: 260px" >
                ...
                <a href="{{ route('advance-salary.show', $item->id) }}" class="btn btn-info btn-sm" title="View Details">
                    <i style="height: 12px; width: 12px" data-feather="eye"></i>
                </a>
                <a href="{{ route('advance-salary.process.export.excel', $item->id) }}" class="btn btn-success btn-sm no-loader" title="Export Excel">
                    <i class="bi bi-file-earmark-excel"></i>
                </a>
                <a href="{{ route('advance-salary.process.print', $item->id) }}" target="_blank" class="btn btn-secondary btn-sm no-loader" title="Print PDF">
    ...
    @empty
        <tr>
            <td colspan="7" class="text-center py-4">No advance salary processes found</td>
        </tr>
    @endforelse
    </tbody>
</table>
