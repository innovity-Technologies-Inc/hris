...
@section('content')
    {{-- Tax Deduction Search & Listing Page --}}
    <div class="row">
        <div class="col-lg-12">
            @can('tax-policy.view')
                    ...
                    <div class="border rounded shadow-sm p-3 filter-section-bg">
                        <form id="filterForm">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    <label for="dateFrom" class="form-label text-muted small fw-semibold mb-1">
                                        Deduction Date From
                                    </label>
                                ...
                                <div class="col-md-3">
                                    <label for="dateTo" class="form-label text-muted small fw-semibold mb-1">
                                        Deduction Date To
                                    </label>
            ...
            <div class="card border-0 shadow-sm rounded">
                ...
                <div class="card-body">
                    <div id="search-result">
                        @include('payroll.tax_deduction.partials.search_results')
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchData(url = "{{ route('tax-deduction.index') }}") {
