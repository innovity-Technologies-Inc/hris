        ...
        <div class="card shadow-sm border-0">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0">
                    ...
                    Arrear Management Batch: <span class="text-primary">{{ $process->batch_id }}</span>
                </h5>
                <a href="{{ route('arrear.index') }}" class="btn btn-outline-secondary btn-sm">
            ...
            <div class="card-body p-4">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover align-middle">
                        ...
                        <tbody>
                            @foreach($process->arrears as $index => $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    @if ($item->status == 'paid')
                                        <span class="badge bg-info-subtle text-info border border-info">Paid</span>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 15px; overflow: hidden;">
            ...
            <div class="modal-body p-0">
                ...
                <div class="px-4 mb-4">
                    <h6 class="text-primary fw-bold mb-3 border-bottom pb-2">Arrear Details</h6>
                    <div class="row align-items-center">
                        <div class="col-6">
                            <div class="p-2 border rounded-3 bg-soft-primary">
                                <label class="text-muted small d-block mb-0">Arrear Amount</label>
                                <span class="fw-bold text-primary fs-5" id="modal-arrear-amount">-</span>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="p-2 border rounded-3">
                                <label class="text-muted small d-block mb-0">Target Payment Cycle</label>
...
<script>
    $(document).ready(function() {
        $('.view-item-details').on('click', function() {
            ...
            else if (data.status === 'Paid') statusEl.addClass('bg-info-subtle text-info border-info');
