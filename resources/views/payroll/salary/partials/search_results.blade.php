    ...
    @forelse($payrollProcesses as $item)
        <tr>
            ...
            <td class="text-center" style="width: 260px" >
                ...
                <a href="{{ route('salary.process.export.excel', $item->id) }}" class="btn btn-success btn-sm no-loader" title="Export Excel">
                    <i class="bi bi-file-earmark-excel"></i>
                </a>
                <a href="{{ route('salary.process.print', $item->id) }}" target="_blank" class="btn btn-secondary btn-sm no-loader" title="Print PDF">
