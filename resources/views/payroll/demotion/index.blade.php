...
@section('content')
    ...
    {{-- Employee Demotion Search --}}
    <div class="row">
        <div class="col-lg-12">
            @can('demotions.view')
            <div class="card border-0 shadow-sm rounded">
                <div class="card-header">
                    <h5 class="card-title mb-0">Search Employee Demotions</h5>
                </div><!-- end card header -->
                        ...
                        <div class="col-md-12">
                            <div class="border rounded shadow-sm p-3 filter-section-bg">
                                <form id="filterForm">
                                    ...
                                    {{-- Second Row: Employee, Decrement Method, Status --}}
                                    <div class="row mb-2">
        ...
        <div class="col-lg-12 mt-3">
            <div class="card border-0 shadow-sm rounded">
                <div class="card-header">
                    <h5 class="card-title mb-0">Employee Demotions List</h5>
                </div>
                <div class="card-body">
                    {{-- Action Buttons --}}
                    <div class="d-flex justify-content-between mb-3">
                        <div class="d-flex gap-2">
                            @can('demotions.create')
                            <a type="button" class="btn btn-warning btn-sm" href="{{ route('demotion.create') }}">
                    ...
                    <div id="search-result">
                        @include('payroll.demotion.partials.search-results')
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchData(url = "{{ route('demotion.index') }}") {
            ...
            $('#exportExcelBtn').on('click', function(e) {
                ...
                const queryString = $('#filterForm').serialize();
                window.location.href = "{{ route('demotion.export.excel') }}?" + queryString;
            });
            ...
            $('#printBtn').on('click', function(e) {
                e.preventDefault();
                const queryString = $('#filterForm').serialize();
                window.open("{{ route('demotion.print') }}?" + queryString, '_blank');
            });
        });
    </script>
@endsection
