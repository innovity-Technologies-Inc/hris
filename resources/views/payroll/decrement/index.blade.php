...
@section('content')
    ...
    {{-- Employee Decrement Search --}}
    <div class="row">
        <div class="col-lg-12">
            @can('decrements.view')
            <div class="card border-0 shadow-sm rounded">
                <div class="card-header">
                    <h5 class="card-title mb-0">Search Employee Decrements</h5>
                </div><!-- end card header -->
        ...
        <div class="col-lg-12 mt-3">
            <div class="card border-0 shadow-sm rounded">
                <div class="card-header">
                    <h5 class="card-title mb-0">Employee Decrements List</h5>
                </div>
                <div class="card-body">
                    {{-- Action Buttons --}}
                    ...
                    <div id="search-result">
                        @include('payroll.decrement.partials.search-results')
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchData(url = "{{ route('decrement.index') }}") {
            ...
            $('#exportExcelBtn').on('click', function(e) {
                ...
                const queryString = $('#filterForm').serialize();
                window.location.href = "{{ route('decrement.export.excel') }}?" + queryString;
            });
            ...
            $('#printBtn').on('click', function(e) {
                e.preventDefault();
                const queryString = $('#filterForm').serialize();
                window.open("{{ route('decrement.print') }}?" + queryString, '_blank');
            });
        });
    </script>
@endsection
