        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Bonus Entry</h5>
                </div>

                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="bonusEntryForm" action="#" method="post">
                                @csrf
                    ...
                    <div class="mb-4">
                        <h6 class="text-primary border-bottom pb-2 mb-3">
                            <i class="fas fa-coins me-2"></i>Bonus Information
                        </h6>
                        <div class="row">
                            <!-- Bonus Plan -->
                            <div class="col-md-6 mb-3">
                                <label for="bonusPlanSelect" class="form-label fw-semibold">
                                    <i class="fas fa-gift text-warning me-1"></i>
                                    Select Bonus Plan <span class="text-danger">*</span>
                                </label>
                                <select id="bonusPlanSelect" class="form-select select2_list" name="bonus_plan_id" required>
                                    <option value="">-- Select Bonus Plan --</option>
                    ...
                    <div class="d-flex justify-content-end gap-2 border-top pt-3 mt-4">
                        ...
                        <button type="submit" class="btn btn-primary px-5">
                            <i class="fas fa-save me-1"></i>Submit Bonus Entry
                        </button>
                    </div>
                    </form>
                </div>
