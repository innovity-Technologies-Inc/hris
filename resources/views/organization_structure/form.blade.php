                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="group_id" id="boardGroupSelect" class="form-select select2_list" required>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="company_id" id="key_company_id" class="form-select select2_list">
                                                <option value="">Select Company</option>
                                                @foreach ($companies as $company)
                                                    <option value="{{ $company->id }}"
                                                        {{ isset($organizationStructure) && $organizationStructure->company_id == $company->id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="branch_unit_id" id="key_business_unit_id" class="form-select select2_list">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="division_id" id="key_division_id" class="form-select select2_list">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="department_id" id="key_department_id" class="form-select select2_list">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="section_id" id="key_section_id" class="form-select select2_list">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <select id="keyEmployeeSelect" class="form-select select2" name="employee_id" required>
        ...
        $(document).ready(function() {
                ...
                $(document).ready(function() {
                    ...
                    $('#boardGroupSelect option').each(function() {
                        if ($(this).val()) {
                            initialBoardGroups.push({ id: $(this).val(), name: $(this).text() });
                        }
                    });
                    ...
                    function resetBoardGroupSelect() {
                        $('#boardGroupSelect').prop('disabled', false).html('<option value="">-- Select Group --</option>');
                        $.each(initialBoardGroups, function(_, item) {
                            $('#boardGroupSelect').append(`<option value="${item.id}">${item.name}</option>`);
                        });
                    }
                    ...
                    $('#boardGroupSelect').on('change', function() {
                        ...
                        if (groupId) {
                            ...
                            $.get(`/get-companies/${groupId}`, function(data) {
                                reset($('#boardCompanySelect'), '-- Select Company --');
                                if (!data.length) {
                                    $('#boardCompanySelect').html('<option value="">No company found</option>');
                                } else {
                    ...
                    function loadKeyDivisions() {
                        ...
                        $.get(`/get-divisions/${companyId}/${locationId}`, function(data) {
                            ...
                            if (!data.length) {
                                $('#key_division_id').html('<option value="">No division found</option>');
                            } else {
                                $.each(data, function(_, item) {
                    ...
                    function loadKeyDepartments() {
                        ...
                        $.get(`/get-departments/${companyId}/${locationId}/${divisionId}`, function(data) {
                            reset($('#key_department_id'), 'Select Department');
                            if (!data.length) {
                                $('#key_department_id').html('<option value="">No department found</option>');
                            } else {
                                $.each(data, function(_, item) {
                    ...
                    $('#key_company_id').on('change', function() {
                        ...
                        @if (App\HelperClass::getGeneralSetting()->branch_status == 1)
                            ...
                            $.get(`/get-units/${companyId}`, function(data) {
                                ...
                                if (!data.length) {
                                    $('#key_business_unit_id').html('<option value="">No branch found</option>');
                                } else {
                                    $.each(data, function(_, item) {
                    ...
                    @if (isset($organizationStructure))
                        ...
                        @if ($organizationStructure->member_type === 'Board Member')
                            ...
                            setTimeout(function() {
                                $('#boardGroupSelect').val('{{ $organizationStructure->group_id }}').trigger('change');
                                
                                @if ($organizationStructure->company_id)
                                setTimeout(function() {
                                    $('#boardCompanySelect').val('{{ $organizationStructure->company_id }}');
                                }, 300);
                                @endif
                            }, 100);
                            @endif
                        ...
                        @if ($organizationStructure->member_type === 'Key Member')
                            @if ($organizationStructure->company_id)
                            setTimeout(function() {
                                $('#key_company_id').val('{{ $organizationStructure->company_id }}').trigger('change');
                                
                                @if ($organizationStructure->branch_unit_id)
                                setTimeout(function() {
                                    $('#key_business_unit_id').val('{{ $organizationStructure->branch_unit_id }}').trigger('change');
                                }, 600);
                                @endif
                                
                                @if ($organizationStructure->division_id)
                                setTimeout(function() {
                                    $('#key_division_id').val('{{ $organizationStructure->division_id }}').trigger('change');
                                }, 900);
                                @endif
                                
                                @if ($organizationStructure->department_id)
                                setTimeout(function() {
                                    $('#key_department_id').val('{{ $organizationStructure->department_id }}').trigger('change');
                                }, 1200);
                                @endif
                                
                                @if ($organizationStructure->section_id)
                                setTimeout(function() {
                                    $('#key_section_id').val('{{ $organizationStructure->section_id }}');
                                }, 1500);
                                @endif
                            }, 300);
                            @endif
