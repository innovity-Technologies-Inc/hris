        ...
        <div class="card border mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <!-- Bonus & Reward Type -->
                    <div class="col-md-6 mb-3">
                        <label class="text-muted small">Bonus & Reward Type</label>
                    ...
                    <div class="border rounded p-3 bg-light">
                        ...
                        <div class="row">
                            ...
                            @if ($plan->salary_rate_type == 'Multiplier')
                                <div class="col-md-6 mb-3">
                                    <label class="text-muted small">Bonus & Reward Percentage</label>
                                    <p class="fw-semibold mb-0">
                ...
                @else
                    ...
                    <div class="border rounded p-3 bg-light">
                        <h6 class="fw-semibold mb-3 text-success">
                            <i class="mdi mdi-cash me-1"></i>Fixed Bonus & Reward Amount
                        </h6>
                        <div class="row">
                            <!-- Fixed Amount Display -->
                            <div class="col-md-6 mb-3">
                                <label class="text-muted small">Bonus & Reward Amount</label>
                                <p class="fw-semibold mb-0">
                                    <span class="badge bg-success fs-6">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                ...
                <form action="{{ route('plan.bonus_plans.delete', $plan->id) }}" method="POST"
                      onsubmit="return confirm('Are you sure you want to delete this bonus & reward plan? This action cannot be undone.');"
                      class="d-inline">
                    @csrf
                    @method('DELETE')
