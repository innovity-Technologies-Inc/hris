        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form action="{{route('plan.meal_plans.store')}}" method="post">
                                @csrf
                                    ...
                                    @foreach($breakfast_plans as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="post" action="{{route('plan.meal_plans.delete', $item->id)}}" style="display: inline">
                                                    @method('delete')
                                                    @csrf
                                            ...
                                            @include('plan.meal_plans.modal.meal_plan_edit')
                                            @include('plan.meal_plans.modal.meal_plan_view')
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
