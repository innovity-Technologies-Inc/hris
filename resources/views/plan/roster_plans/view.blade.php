...
@section('content')
    <div class="container-fluid mt-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="border rounded p-3 bg-light h-100">
                            ...
                            <div class="text-end">
                                <a href="{{ route('plan.shift_plans.show', $plan->first_shift_id) }}"
                    ...
                    <div class="col-md-4">
                        <div class="border rounded p-3 bg-light h-100">
                            ...
                            <div class="text-end">
                                <a href="{{ route('plan.shift_plans.show', $plan->second_shift_id) }}"
                                    class="btn btn-sm btn-outline-primary">
                                    <i class="mdi mdi-eye me-1"></i>View
                                </a>
                            </div>
                    ...
                    @if ($plan->third_shift_id && $plan->getThirdShift)
                        <div class="col-md-4">
                            <div class="border rounded p-3 bg-light h-100">
                                ...
                                <div class="text-end">
                                    <a href="{{ route('plan.shift_plans.show', $plan->third_shift_id) }}"
                                        class="btn btn-sm btn-outline-primary">
                                        <i class="mdi mdi-eye me-1"></i>View
                                    </a>
                                </div>
        ...
        <div class="d-flex float-end justify-content-right align-items-center mb-4">
            <div>
                <a href="{{ route('plan.roster_plans.edit', $plan->id) }}" class="btn btn-primary me-2">
                    <i class="mdi mdi-pencil me-1"></i>Edit
                </a>
                <a href="{{ route('plan.roster_plans.index') }}" class="btn btn-secondary">
