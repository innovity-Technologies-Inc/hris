...
@section('content')
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <a type="button" class="btn btn-warning btn-sm" href="{{ route('plan.roster_plans.create') }}">
                ...
                <div class="card-body" id="search-result">
                    @include('plan.roster_plans.search_results')
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchData(url = "{{ route('plan.roster_plans.index') }}") {
