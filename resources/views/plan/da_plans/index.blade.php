...
@section('content')
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <a type="button" class="btn btn-warning btn-sm" href="{{ route('plan.da_plans.create') }}">
                ...
                <div class="card-body" id="search-result">
                    @include('plan.da_plans.search_results')
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchData(url = "{{ route('plan.da_plans.index') }}") {
            ...
            $('#resetFilters').on('click', function() {
                ...
                window.location.href = "{{ route('plan.da_plans.index') }}";
            });
