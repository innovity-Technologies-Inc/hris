...
@section('content')
    ...
    <div class="container-fluid mt-4">
                ...
                @if ($shift)
                    <div class="border rounded p-3 bg-light">
                        <h6 class="fw-semibold mb-3 text-primary">
                            ...
                            <a href="{{ route('plan.shift_plans.show', $shift->id) }}"
        ...
        <div class="d-flex float-end justify-content-right align-items-center mb-4">
            <div>
                <a href="{{ route('plan.off_day_plans.edit', $plan->id) }}" class="btn btn-primary me-2">
                    <i class="mdi mdi-pencil me-1"></i>Edit
                </a>
                <a href="{{ route('plan.off_day_plans.index') }}" class="btn btn-secondary">
