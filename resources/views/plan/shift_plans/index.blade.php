        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <a type="button" class="btn btn-warning btn-sm" href="{{ route('plan.shift_plans.create') }}">
                ...
                <div class="card-body" id="search-result">
                    @include('plan.shift_plans.search_results')
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="https://code.jquery.com/jquery-3.6.4.min.js"></script>
     <script>
        $(document).ready(function() {
            ...
            function fetchData(url = "{{ route('plan.shift_plans.index') }}") {
