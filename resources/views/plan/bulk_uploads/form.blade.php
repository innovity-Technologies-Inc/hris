...
@section('content')
                                ...
                                <div class="card h-100 border shadow-sm professional-card">
                                    <div class="card-body p-4">
                                        ...
                                        <button type="button"
                                            ...
                                            data-form-action="{{ route('plan.meal_plans.import') }}"
                                ...
                                <div class="card h-100 border shadow-sm professional-card">
                                    <div class="card-body p-4">
                                        ...
                                        <button type="button"
                                            ...
                                            data-form-action="{{ route('plan.shift_plans.import') }}"
                                ...
                                <div class="card h-100 border shadow-sm professional-card">
                                    <div class="card-body p-4">
                                        ...
                                        <button type="button"
                                            ...
                                            data-form-action="{{ route('plan.leave_plans.import') }}"
                                ...
                                <div class="card h-100 border shadow-sm professional-card">
                                    <div class="card-body p-4">
                                        ...
                                        <button type="button"
                                            ...
                                            data-form-action="{{ route('plan.ot_plans.import') }}"
                                ...
                                <div class="card h-100 border shadow-sm professional-card">
                                    <div class="card-body p-4">
                                        ...
                                        <button type="button"
                                            ...
                                            data-section-name="Overtime Plan" data-section-number="3"
                                            data-form-action="{{ route('plan.roster_plans.import') }}"
                                ...
                                <div class="card h-100 border shadow-sm professional-card">
                                    <div class="card-body p-4">
                                        ...
                                        <button type="button"
                                            ...
                                            data-section-name="Overtime Plan" data-section-number="3"
                                            data-form-action="{{ route('plan.off_day_plans.import') }}"
                                ...
                                <div class="card h-100 border shadow-sm professional-card">
                                    <div class="card-body p-4">
                                        ...
                                        <button type="button"
                                            ...
                                            data-form-action="{{ route('plan.bonus_plans.import') }}"
                                ...
                                <div class="card h-100 border shadow-sm professional-card">
                                    <div class="card-body p-4">
                                        ...
                                        <button type="button"
                                            ...
                                            data-form-action="{{ route('plan.allowance_plans.import') }}"
                                ...
                                <div class="card h-100 border shadow-sm professional-card">
                                    <div class="card-body p-4">
                                        ...
                                        <button type="button"
                                            ...
                                            data-form-action="{{ route('plan.ta_plans.import') }}"
                                ...
                                <div class="card h-100 border shadow-sm professional-card">
                                    <div class="card-body p-4">
                                        ...
                                        <button type="button"
                                            ...
                                            data-form-action="{{ route('plan.da_plans.import') }}"
    ...
    <!-- Include the modal -->
    @include('plan.bulk_uploads.import')
