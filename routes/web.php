...
Route::controller(EmployeeMovementsController::class)->prefix('movement')->middleware('auth')->group(function (){
    ...
    Route::middleware('permission:movement.process')->group(function () {
...
Route::prefix('advance-salary')->name('advance-salary.')->controller(\App\Http\Controllers\Payroll\AdvanceSalaryController::class)->middleware('auth')->group(function () {
    Route::middleware('permission:advance-salary.view')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::get('export-excel', 'exportExcel')->name('export.excel');
        Route::get('print', 'printIndex')->name('print');
        Route::get('process/{id}/export-excel', 'exportProcessExcel')->name('process.export.excel');
    ...
    Route::middleware('permission:advance-salary.create')->group(function () {
        Route::get('create', 'create')->name('create');
        Route::post('store', 'save')->name('store');
    });
    Route::middleware('permission:advance-salary.edit')->group(function () {
        Route::get('edit/{id}', 'edit')->name('edit');
        Route::put('{id}/update', 'save')->name('update');
    });
...
Route::prefix('disbursement')->name('disbursement.')->controller(\App\Http\Controllers\Payroll\DisbursementController::class)->middleware('auth')->group(function () {
    Route::middleware('permission:disbursement.view')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::get('show/{id}', 'show')->name('show');
        Route::get('batch-details-data/{id}', 'getBatchData')->name('batch_details_data');
        Route::get('disbursement-items/{id}', 'getDisbursementItems')->name('items_data');
    });
...
Route::prefix('transfer')->name('transfer.')->middleware('auth')->group(function () {
    ...
    Route::prefix('api')->name('api.')->controller(\App\Http\Controllers\Transfer\TransferAPIController::class)->group(function () {
        ...
        Route::post('adjustment', 'adjustment')->name('adjustment')->middleware('permission:transfers.edit');
        Route::delete('delete/{id}', 'delete')->name('delete')->middleware('permission:transfers.delete');
    });
});
